...
function calcularIMC(){
  ...
  return(
    <div className="app">
      ...
      <input type="text" placeholder="Peso em (kg) Ex: 90" value={peso} onChange={ (e) => setPeso(e.target.value) } name="" id="" />

      <input type="text" placeholder="Altura em (cm) Ex: 180" value={altura} onChange={ (e) => setAltura(e.target.value) } name="" id="" />
